...
- **Checksum is self-consistency, not a publisher signature.** Full SHA-256 binds the manifest. It does not prove who sealed it.
- **Public packs hash examples; they do not keep a full private reservoir.** `--include-private` serializes raw text. Do not use that on real subjective-symbol data until v0.2 public/private auditor views exist.
